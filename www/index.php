...
if (!empty($_GET['player'])) {
  ...
  echo TrogReport::showCombo('Dg', 'Sk', '2014-03-03', '2014-03-09');
  echo TrogReport::showCombo('HO', 'DK', '2014-02-24', '2014-03-02');
  echo TrogReport::showCombo('Fe', 'Su', '2014-02-17', '2014-02-23');
